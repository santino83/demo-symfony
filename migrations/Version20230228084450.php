 ...
 */
final class Version20230228084450 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, firstname VARCHAR(80) NOT NULL, lastname VARCHAR(80) NOT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, created_at, updated_at, firstname, lastname) SELECT id, email, roles, password, created_at, updated_at, \'\', \'\' FROM __temp__user');
